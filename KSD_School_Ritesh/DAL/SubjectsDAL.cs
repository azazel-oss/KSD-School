...
namespace KSD_School_Ritesh.DAL
{
    public class SubjectsDAL
    {
        ...
        public int subAdd(Subjects subjectDAL)
        {
            int i;
            using (SqlConnection con = new SqlConnection(cs))
            {
                ...
                com.CommandType = CommandType.StoredProcedure;
                com.Parameters.AddWithValue("@feild1", subjectDAL.Subject_id);
                com.Parameters.AddWithValue("@feild2", subjectDAL.Subject_name);
        ...
        public int subUpdate(Subjects subjectDAL)
        {
            int i;
            using (SqlConnection con = new SqlConnection(cs))
            {
